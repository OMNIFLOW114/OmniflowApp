// src/components/icons/BrokenOmniFlowTrolley.jsx
import React from "react";

const BrokenOmniFlowTrolley = ({ size = 280 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1280 1211"
      width={size}
      height={size}
      fill="currentColor"
    ...
    >
      ...
      {/* Floor shadow for the fallen trolley */}
      <ellipse cx="640" cy="1150" rx="350" ry="40" fill="rgba(0,0,0,0.12)" />
      <ellipse cx="640" cy="1150" rx="200" ry="20" fill="rgba(0,0,0,0.08)" />

      {/* Fallen Trolley - Rotated */}
      <g transform="translate(640, 580) rotate(-25) translate(-640, -580)" filter="url(#shadow)">
        
        {/* Original OmniFlow Trolley Logo */}
...
-78 339 29 339 199 0 54 -28 125 -63 163 -57 62 -176 87 -253 55z"/>
        ...
        {/* Red cracks and damage overlays */}
        <g opacity="0.7">
          {/* Crack on the trolley body */}
          <path d="M550 7000 L600 7200 L580 7500 L650 7800" stroke="#ef4444" strokeWidth="8" fill="none" strokeLinecap="round" />
          <path d="M600 7200 L680 7350" stroke="#ef4444" strokeWidth="6" fill="none" strokeLinecap="round" />
          
          {/* Broken wheel marks */}
          <circle cx="400" cy="9500" r="60" stroke="#ef4444" strokeWidth="5" fill="none" strokeDasharray="10,10" />
          <circle cx="900" cy="9500" r="60" stroke="#ef4444" strokeWidth="5" fill="none" strokeDasharray="10,10" />
        </g>
      </g>

      {/* Fallen WiFi Symbol on the floor with Red Diagonal Slash */}
      <g transform="translate(750, 980) rotate(-15)">
        {/* WiFi shadow */}
        <ellipse cx="0" cy="15" rx="50" ry="10" fill="rgba(0,0,0,0.15)" />
        
        {/* WiFi icon - fallen on floor */}
        <g opacity="0.9">
          <path 
            d="M3 8C5 5.90088 8.0418 4 12 4C15.9582 4 19 5.90088 21 8" 
            stroke="#dc2626" 
            strokeWidth="3.5" 
            fill="none" 
            strokeLinecap="round" 
            strokeLinejoin="round"
            transform="scale(2.5) translate(-2.5, -1.5)"
          />
          <path 
            d="M5.5 11C7.13825 9.40451 9.44477 8.19825 12 8.19825C14.5552 8.19825 16.8618 9.40451 18.5 11" 
            stroke="#dc2626" 
            strokeWidth="3.5" 
            fill="none" 
            strokeLinecap="round" 
          ...
          />
          <path 
            d="M8 14C9.06151 13.0028 10.4633 12.3965 12 12.3965C13.5367 12.3965 14.9385 13.0028 16 14" 
            stroke="#dc2626" 
            strokeWidth="3.5" 
            fill="none" 
            strokeLinecap="round" 
        ...
        {/* Bold Red Diagonal Stroke through the WiFi */}
        <line 
          x1="-55" 
          y1="-30" 
          x2="55" 
        ...
        {/* Cross/break effect at the ends */}
        <line x1="52" y1="38" x2="60" y2="30" stroke="#dc2626" strokeWidth="4" strokeLinecap="round" />
        <line x1="52" y1="38" x2="60" y2="46" stroke="#dc2626" strokeWidth="4" strokeLinecap="round" />
        <line x1="-52" y1="-28" x2="-60" y2="-36" stroke="#dc2626" strokeWidth="4" strokeLinecap="round" />
        
        {/* Floor cracks near fallen WiFi */}
        <path d="M-60 45 L-55 52 L-62 58" stroke="#ef4444" strokeWidth="3" fill="none" opacity="0.5" />
        <path d="M60 42 L65 48 L60 55" stroke="#ef4444" strokeWidth="3" fill="none" opacity="0.5" />
      </g>

      {/* Scattered particles/items on floor */}
      <g opacity="0.4">
        <circle cx="300" cy="1050" r="5" fill="#ef4444" />
        <circle cx="450" cy="1080" r="4" fill="#f59e0b" />
        <circle cx="850" cy="1060" r="5" fill="#10b981" />
        <circle cx="980" cy="1040" r="4" fill="#ef4444" />
        <circle cx="550" cy="1100" r="3" fill="#3b82f6" />
        <circle cx="700" cy="1090" r="4" fill="#8b5cf6" />
      </g>
    </svg>
  );
};

export default BrokenOmniFlowTrolley;